...
public abstract class UpdateLayout {
	//layout for insert and delete page 
	public static BorderPane updatePane() {
		BorderPane update_borderPane = new BorderPane();

		Button update_button = new Button("I Want To Update");
		
		
		update_button.setMinWidth(150);
	
		VBox vbox = new VBox();

		

		vbox.getChildren().addAll(update_button);
		//vbox.setPadding(new Insets(10, 50, 50, 50));
		vbox.setSpacing(10);
		update_borderPane.setTop(vbox);
...
//	    vbox2.getChildren().add(title);
		...
		update_borderPane.setLeft(vbox1);
...
//				hb.setSpacing(10);
				...
				update_borderPane.setCenter(insert_scrollPane);
				String label_table;
...
//							 textFields.add(((TextField) (fillIn_table.getChildren().get(i))).getText());
						 ...
						 ResultSet rs = null;
						 try {
							 String query = helper.updateQuery(textFields1, table_name);
